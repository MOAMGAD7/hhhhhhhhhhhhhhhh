...
public class OpenAIChatbot {
    ...
    public static String getChatResponse(String userMessage) throws IOException {
        // بناء الطلب لـ OpenAI API
        JSONObject requestBody = new JSONObject();
        requestBody.put("model", "gpt-3.5-turbo"); // استخدم gpt-3.5-turbo لأنه أرخص وسريع
        ...
        requestBody.put("temperature", 0.7); // درجة الإبداع في الردود
